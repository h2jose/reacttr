Este proyecto fue generado por [Create React App](https://github.com/facebookincubator/create-react-app).
...
- [CAPITULO 3: Comunicación de datos entre Componentes (props) (2)] (#).
